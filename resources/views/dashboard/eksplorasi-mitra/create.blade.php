                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="/mitra/eksplorasi" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        @include('template-dashboard.mitra-depen')
                                        <div class="form-group row">
                                        ...
                                        <a href="/mitra/eksplorasi" class="btn btn-light">Kembali</a>
                                    </form>
                                </div>
                            </div>
                        </div>
